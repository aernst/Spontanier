...
window.$t = window.Tiggzi = window.Tiggr = (function() {
    ...
    var tiggziFunction = function() {
        ...
        var context;
        var elem;
        var screenCtxt = $("#" + Tiggr.CurrentScreen);
...
(function($t, $) {
	 ...
	 * @class BaseComponent
	 */
	$t.BaseComponent = $t.createClass(null, /** @lends $t.BaseComponent.prototype */ {
	 ...
	 */
	$t.ConsoleLogger = $t.createClass(null, /** @lends $t.ConsoleLogger.prototype */ {
	 ...
	 */
	$t.MappingVisitor = $t.createClass(null, /** @lends $t.MappingVisitor.prototype */{
	 ...
	 * @class RenderVisitor
	 */
	$t.RenderVisitor = $t.createClass($t.MappingVisitor, /** @lends $t.RenderVisitor.prototype */ {
		init: function(data) {
	...
	/**
	 * @class RequestDataBuilderVisitor
	 */
	$t.RequestDataBuilderVisitor = $t.createClass($t.MappingVisitor, /** @lends $t.RequestDataBuilderVisitor.prototype */ {
	 ...
	 */
	$t.DataSource = $t.createClass(null, /** @lends $t.DataSource.prototype */{
		...
		__setupDisplay: function(cs) {			
			for(var i = 0; i < this.__outMappings.length; i++) {
				if(this.__outMappings[i].SET) {
					c = $("#" + Tiggzi.CurrentScreen + " [dsid=" + this.__outMappings[i].ID + "]");
	 ...
	 */
	$t.GenericService = $t.createClass(null, /** @lends $t.GenericService.prototype */ {
	 ...
	 * @class RestService
	 */
	$t.RestService = $t.createClass(null, /** @lends $t.RestService.prototype */ {
	 ...
	 */
	$t.GeolocationService = $t.createClass(null, /** @lends $t.GeolocationService.prototype */ {
	 ...
	 */
	$t.ContactsService = $t.createClass(null, /** @lends $t.ContactsService.prototype */ {
	 ...
	 */
	$t.BarCodeService = $t.createClass(null, /** @lends $t.BarCodeService.prototype */ {
	 ...
	 * @class CameraService
	 */
	$t.CameraService = $t.createClass(null, /** @lends $t.CameraService.prototype */ {
	 ...
	 * @class TiggziWrapper
	 */
	$t.TiggziWrapper = $t.TiggrWrapper = $t.createClass(null, /** @lends $t.TiggziWrapper.prototype */ {
	...
	/**
	 * @class TiggziMapComponent
	 */
	$t.TiggziMapComponent = $t.TiggrMapComponent = $t.createClass($t.TiggziWrapper, /** @lends $t.TiggziMapComponent.prototype */ {
		init:function(componentId,options){
	...
	/**
	 * @class TiggziMobileCarouselComponent
	 */
	$t.TiggziMobileCarouselComponent = $t.TiggrMobileCarouselComponent = $t.createClass($t.TiggziWrapper, /** @lends $t.TiggziMobileCarouselComponent.prototype */ {
		init:function(componentId,options){
				//this.constructor.$super.init(componentId,options);				
	...
	/**
	 * @class TiggrMobileDatePickerComponent
	 */
	$t.TiggrMobileDatePickerComponent = $t.createClass($t.TiggrWrapper, /** @lends $t.TiggrMobileDatePickerComponent.prototype */ {
		init:function(componentId,options){
    ...
    $t.setDetailContent = function(pageUrl) {
        ...
        if ($("#" + Tiggr.CurrentScreen + " .content-primary").length || 
        ...
        function processResponce(data) {
			...
			if($('.ui-page-active .content-primary').length == 1) {
				...
				selector = "#" + Tiggr.CurrentScreen + " .content-primary";
			}        	
